...
namespace ScheduleMicroService.Repository
{
    public class ScheduleRepository:IScheduleRepository
    {
        ...
        {
            doctors.Add(new Doctor { Name = "Luke Skywalker", Specialization = "Orthopaedics", Mobile = 8745421586 });
            doctors.Add(new Doctor { Name = "Obiwan Kenobi", Specialization = "General", Mobile = 8452175396 });
            doctors.Add(new Doctor { Name = "Mace Windu", Specialization = "General", Mobile = 9964512785 });
            doctors.Add(new Doctor { Name = "Master Yoda", Specialization = "Orthopaedics", Mobile = 9968574589 });
